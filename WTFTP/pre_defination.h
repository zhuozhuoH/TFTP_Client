#ifndef PRE_DEFINATION_H
#define PRE_DEFINATION_H
...
typedef struct {
    bool Extended_flag;
    bool tsize_flag, blksize_flag, timeout_flag;
    int tsize, blksize, timeout;
}EXTEND;
#endif // PRE_DEFINATION_H
